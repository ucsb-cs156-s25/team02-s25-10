...
import UCSBArticlesIndexPage from "main/pages/UCSBArticles/UCSBArticlesIndexPage";
...
describe("UCSBArticlesIndexPage tests", () => {
  ...
  test("Renders with Create Button for admin user", async () => {
    ...
    render(
      <QueryClientProvider client={queryClient}>
        <MemoryRouter>
          <UCSBArticlesIndexPage />
        </MemoryRouter>
      </QueryClientProvider>
    );

    await waitFor(() => {
      expect(screen.getByText(/Create UCSB Article/)).toBeInTheDocument();
    });
    const button = screen.getByText(/Create UCSB Article/);
  ...
  test("renders three articles correctly for regular user", async () => {
    ...
    expect(screen.queryByText(/Create UCSB Article/)).not.toBeInTheDocument();
  });
