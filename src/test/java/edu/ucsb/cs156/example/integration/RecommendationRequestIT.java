...
public class RecommendationRequestIT {
        ...
        public void an_admin_user_can_post_a_new_recommendationrequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/recommendationrequests/post?requesterEmail=mihirkondapalli@" +
                                        "ucsb.edu&professorEmail=pconrad@ucsb.edu&explanation=Test&dateRequested=2022-01-03T00:00:00" +
                                        "&dateNeeded=2025-01-03T00:00:00&done=false")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
